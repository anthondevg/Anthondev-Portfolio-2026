      ...
      <main id="main">
        <section className={`relative grid min-h-svh grid-cols-[minmax(0,1.04fr)_minmax(390px,.96fr)] items-center gap-8 overflow-hidden pt-[148px] pb-[52px] max-md:min-h-0 max-md:grid-cols-1 max-md:pt-[150px] max-sm:pt-[125px] max-sm:pb-8 ${sectionShell}`} aria-labelledby="hero-title">
          ...
          <div className="relative z-3 pb-8">
            ...
            <h1 id="hero-title" className="m-0 mt-8 font-display text-[clamp(1.8rem,2.55vw,2.75rem)] leading-none font-bold tracking-[-.035em] text-[#f8f5fb] [text-shadow:0_8px_24px_rgba(0,0,0,.2)]">Anthony Gonzalez</h1>
            <p className="mt-3 mb-0 w-max max-w-[780px] bg-clip-text font-display text-[clamp(3.35rem,6.15vw,6.35rem)] leading-[.88] font-semibold tracking-[-.055em] text-transparent [-webkit-text-fill-color:transparent] [-webkit-text-stroke:.45px_rgba(225,190,224,.38)] [background-image:linear-gradient(180deg,rgba(184,139,190,.58)_0%,rgba(122,75,137,.5)_38%,rgba(75,42,92,.58)_64%,rgba(39,24,58,.86)_100%)] [filter:drop-shadow(0_1px_0_rgba(255,255,255,.12))_drop-shadow(0_9px_18px_rgba(0,0,0,.4))] max-md:text-[clamp(3.25rem,11.5vw,5.7rem)] max-sm:max-w-full max-sm:text-[clamp(2.9rem,13.5vw,4.4rem)]">AI Engineer</p>
            <p className="mt-11 mb-0 max-w-[550px] text-[clamp(1rem,1.25vw,1.18rem)] leading-[1.7] text-[#c9c3d0] max-sm:mt-8 max-sm:max-w-[90%]">I design and build intelligent products where thoughtful engineering meets creative direction.</p>
            <div className="mt-9 flex items-center gap-8 max-sm:flex-col max-sm:items-stretch max-sm:gap-3">
              <CtaButton href="#work" label="View" accent="Work" />
              <Link className="relative inline-flex gap-4 py-3.5 text-[.76rem] font-bold text-[#ddd7e6] after:absolute after:bottom-2.5 after:right-0 after:left-0 after:h-px after:bg-[#6f6878] max-sm:w-full max-sm:justify-between" href="#contact">Start a conversation <span aria-hidden="true">↗</span></Link>
            </div>
          </div>
          <HeroVisual />
