...
export function HeroVisual() {
  return (
    <div className="relative z-2 h-[min(65vw,670px)] min-h-[500px] overflow-hidden max-h-[68svh] max-md:h-[min(110vw,690px)] max-md:max-h-none max-sm:hidden">
      ...
      <HeroPortrait className="absolute top-1/2 right-[22%] z-3 w-[42%] -translate-y-1/2 max-md:left-1/2 max-md:right-auto max-md:w-[38%] max-md:-translate-x-1/2" />
