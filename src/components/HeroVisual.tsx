...
export function HeroVisual() {
  ...
  return (
    <div className="relative z-2 h-[min(65vw,670px)] min-h-[500px] max-h-[68svh] max-md:h-[min(110vw,690px)] max-md:max-h-none max-sm:h-[118vw] max-sm:min-h-[430px]">
      ...
      <div className="absolute z-0 top-[8%] left-[6%] w-[85%] aspect-square rounded-full bg-[radial-gradient(circle_at_48%_42%,transparent_0_32%,rgba(112,71,255,.28)_32.5%,transparent_34%),radial-gradient(circle_at_50%_50%,rgba(49,26,103,.34),transparent_64%)]" aria-hidden="true" />
